...
import { Folder, Key, Loader2, Lock, Save } from 'lucide-react'
import { useForm } from 'react-hook-form'
import { cn } from '@/shared/lib/utils'
import { Button, Input, Label } from '@/shared/ui'
import { type ConnectionFormData, connectionSchema } from '../model/connection-schema'
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] opacity-60">Use password authentication</p>
            </div>
          </button>
          <button
            type="button"
      ...
      {authMethod === 'privateKey' && (
        <div className="space-y-4 animate-fade-in">
          <div className="space-y-2">
            <Label htmlFor="privateKeyPath" className="text-xs font-medium text-muted-foreground">
              PRIVATE KEY FILE
            </Label>
            ...
            {errors.privateKeyPath && (
              <p className="text-xs text-red-400">{errors.privateKeyPath.message}</p>
            )}
          </div>
          <div className="space-y-2">
            <Label htmlFor="passphrase" className="text-xs font-medium text-muted-foreground">
